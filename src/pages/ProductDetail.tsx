...
const ProductDetail = () => {
  ...
  const products = {
    "blue-ambient": {
      ...
      image: blueAmbient,
      description:
        "Sistema de filtración ambiental moderno con tecnología de membrana de ósmosis inversa. Puede eliminar virus, bacterias, gérmenes y hasta 3,500 contaminantes adicionales con una pureza de 0.0001μ, hasta 99.99% seguro para remover del agua.",
      features: [
    ...
    "blue-pure": {
      ...
      image: bluePure,
      description:
        "Sistema de purificación avanzada con tecnología de ósmosis inversa de última generación. Diseñado para eliminar hasta 99.99% de contaminantes, proporcionando agua ultra pura para el consumo diario.",
      features: [
    ...
    "blue-cafe": {
      ...
      image: blueCafe,
      description:
        "Sistema especializado para la preparación perfecta de café y bebidas calientes. Optimiza el contenido mineral del agua para realzar el sabor y aroma de cada taza.",
      features: [
    ...
    "blue-sparkling": {
      ...
      image: blueSparkling,
      description:
        "Sistema innovador que produce agua carbonatada fresca y purificada al instante. Combina filtración avanzada con tecnología de carbonatación para burbujas perfectas.",
      features: [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              {product.popular && <Badge className="mb-4">Más Popular</Badge>}
            </div>
